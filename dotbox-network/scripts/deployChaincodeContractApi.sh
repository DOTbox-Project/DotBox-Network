...
checkCommitReadyness2(){
    ...
    peer lifecycle chaincode checkcommitreadiness --channelID $CHANNEL_NAME \
    --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_PROCESSORORG_CA \
...
checkCommitReadyness3(){
    ...
    peer lifecycle chaincode checkcommitreadiness --channelID $CHANNEL_NAME \
    --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_REGULATORORG_CA \
    --name ${CC_NAME} --version ${VERSION} \
    --sequence ${VERSION} --output json
...
checkCommitReadyness4(){
    ...
    peer lifecycle chaincode checkcommitreadiness --channelID $CHANNEL_NAME \
    --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_WHOLESALEORG_CA \
    --name ${CC_NAME} --version ${VERSION} \
    --sequence ${VERSION} --output json
...
checkCommitReadyness5(){
    ...
    peer lifecycle chaincode checkcommitreadiness --channelID $CHANNEL_NAME \
    --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_RETAILORG_CA \
    --name ${CC_NAME} --version ${VERSION} \
    --sequence ${VERSION} --output json
...
checkCommitReadyness6(){
    ...
    peer lifecycle chaincode checkcommitreadiness --channelID $CHANNEL_NAME \
    --peerAddresses localhost:7051 --tlsRootCertFiles $PEER0_CONSUMERORG_CA \
    --name ${CC_NAME} --version ${VERSION} \
    --sequence ${VERSION} --output json
...
#     peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.dot-box.com \
